(() => {
  ...
  function openPlantEditor(plant = null) {
    ...
    form.elements.nameEn.value = plant?.names?.en || "";
    form.elements.nameRu.value = plant?.names?.ru || "";
    form.elements.nameZh.value = plant?.names?.zh || "";
  ...
  $("#plantForm").addEventListener("submit", async (event) => {
    ...
    const names = { en: form.elements.nameEn.value.trim() };
    if (form.elements.nameRu.value.trim()) names.ru = form.elements.nameRu.value.trim();
    if (form.elements.nameZh.value.trim()) names.zh = form.elements.nameZh.value.trim();

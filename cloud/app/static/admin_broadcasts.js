(() => {
  ...
  style.textContent = `
    ...
    .broadcast-preview img{display:block;max-width:100%;max-height:320px;border-radius:12px;margin-bottom:12px}.broadcast-preview-text{white-space:pre-wrap;line-height:1.45}
